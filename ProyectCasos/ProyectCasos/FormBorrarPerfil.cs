...
{
    public partial class FormBorrarPerfil : Form
    {
        public FormBorrarPerfil()
        {
            InitializeComponent();
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                cn.AbrirConeccion();
                SqlCommand com = new SqlCommand("exec dbo.SP_BorrarPerfil'" + int.Parse(txtIdPerfil.Text) + "'", cn.AbrirConeccion());
                com.ExecuteNonQuery();
