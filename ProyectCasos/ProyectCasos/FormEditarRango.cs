...
{
    public partial class FormEditarRango : Form
    {
        public FormEditarRango()
        {
            InitializeComponent();
        }
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (int.Parse(txtIdRango.Text) > 0)
                {

                    cn.AbrirConeccion();
                    SqlCommand com = new SqlCommand("exec dbo.SP_ActualizarRango '" + int.Parse(txtIdRango.Text) + "','" + txtNombreRango.Text + "'", cn.AbrirConeccion());
                    com.ExecuteNonQuery();
                    //cn.Close();
