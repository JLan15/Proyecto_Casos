...
{
    public partial class FormAgregarJuzgadoFiscalia : Form
    {
        public FormAgregarJuzgadoFiscalia()
        {
            InitializeComponent();
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            FormVerJuzgadoFiscalia FrmVerJuzgado = new FormVerJuzgadoFiscalia();
            ...
            {
                cn.AbrirConeccion();
                SqlCommand com = new SqlCommand("exec dbo.SP_CrearJuzgadoFiscalia '" + int.Parse(txtIdJuzgado.Text) + "', '" + txtNombreJuzgado.Text + "'", cn.AbrirConeccion());
                com.ExecuteNonQuery();
                FrmVerJuzgado.CargarDatosDataGridViewJuzgado();
