...
{
    public partial class FormBorrarDelito : Form
    {
        public FormBorrarDelito()
        {
            InitializeComponent();
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                cn.AbrirConeccion();
                SqlCommand com = new SqlCommand("exec dbo.SP_BorrarDelito'" + int.Parse(txtIdDelito.Text) + "'", cn.AbrirConeccion());
                com.ExecuteNonQuery();
