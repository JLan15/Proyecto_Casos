...
{
    public partial class FormBorrarEstadoCasos : Form
    {
        public FormBorrarEstadoCasos()
        {
            InitializeComponent();
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                cn.AbrirConeccion();
                SqlCommand com = new SqlCommand("exec dbo.SP_BorrarEstadoCasos'" + int.Parse(txtIdEstado.Text) + "'", cn.AbrirConeccion());
                com.ExecuteNonQuery();
