...
{
    public partial class FormEditarDelito : Form
    {
        public FormEditarDelito()
        {
            InitializeComponent();
        }
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (int.Parse(txtIdDelito.Text) > 0)
                {

                    cn.AbrirConeccion();
                    SqlCommand com = new SqlCommand("exec dbo.SP_ActualizarDelito '" + int.Parse(txtIdDelito.Text) + "','" + txtNombreDelito.Text + "'", cn.AbrirConeccion());
                    com.ExecuteNonQuery();
                    //cn.Close();
